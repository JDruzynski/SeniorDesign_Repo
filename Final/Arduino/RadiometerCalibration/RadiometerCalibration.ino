...
char receivedChar;
String readString;
float ads1_multiplier, ads2_multiplier;
...
void loop() {
  ...
  if (onoff == true){
    //Thermistor 1 is on the back of the radiometer, thermistor 2 is on the side
    Serial.print("Radiometer mV: "); Serial.println(ads1.readADC_Differential_0_1());
    Serial.print("T1: "); Serial.println(getThermistor(1));
    Serial.print("T2: "); Serial.println(getThermistor(2));
    
    //Matlab will split up those strings and extract just the numerical portion // * ads1_multiplier
